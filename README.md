...
<style>
.lang-switch { display: flex; justify-content: center; gap: 0; margin: 16px 0 24px; }
...
.lang-switch label:first-of-type { border-radius: 6px 0 0 6px; border-right: none; }
.lang-switch label:last-of-type { border-radius: 0 6px 6px 0; }
